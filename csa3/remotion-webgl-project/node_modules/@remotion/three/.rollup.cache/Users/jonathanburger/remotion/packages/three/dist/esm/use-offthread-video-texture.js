...
import { cancelRender, continueRender, delayRender, getRemotionEnvironment, Internals, useCurrentFrame, useVideoConfig, } from 'remotion';
import { NoReactInternals } from 'remotion/no-react';
export const useInnerVideoTexture = ({ playbackRate, src, transparent, toneMapped, }) => {
...
export function useOffthreadVideoTexture({ src, playbackRate = 1, transparent = false, toneMapped = true, }) {
    if (!src) {
